...
export const DashboardErrorIcon: React.FC<Props> = ({
 width = '18px',
 height = '18px',
 fill = '#000000',
}) => {
 return (
  ...
  >
   ...
   <g clipPath="url(#error-icon-clip)" transform="translate(-679 -117)">
...
export default DashboardErrorIcon;